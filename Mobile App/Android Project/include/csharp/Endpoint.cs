...
namespace VidyoClient
{
	public class Endpoint: IDisposable {
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void OnVirtualVideoSourceExternalMediaBufferReleased(IntPtr e, IntPtr virtualVideoSource, IntPtr buffer, ulong size);
...
#endif
		private static void OnVirtualVideoSourceExternalMediaBufferReleasedDelegate(IntPtr e, IntPtr virtualVideoSource, IntPtr buffer, ulong size){
			Endpoint csE = null;
			if(e != IntPtr.Zero){
				if(Endpoint.VidyoEndpointGetUserDataNative(e) == IntPtr.Zero)
					csE = new Endpoint(e);
