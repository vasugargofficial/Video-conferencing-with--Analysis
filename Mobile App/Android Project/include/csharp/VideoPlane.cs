...
namespace VidyoClient
{
	public class VideoPlaneFactory
	{
		...
		{
			IntPtr objPtr = VidyoVideoPlaneConstructDefaultNative();
			return new VideoPlane(objPtr);
		}
		public static void Destroy(VideoPlane obj)
		{
			VidyoVideoPlaneDestructNative(obj.GetObjectPtr());
		}
	}
	public class VideoPlane{
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoVideoPlaneSetheightNative(IntPtr obj, ulong height);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern ulong VidyoVideoPlaneGetoffsetNative(IntPtr obj);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoVideoPlaneSetoffsetNative(IntPtr obj, ulong offset);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern ulong VidyoVideoPlaneGetpitchNative(IntPtr obj);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoVideoPlaneSetpitchNative(IntPtr obj, ulong pitch);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern ulong VidyoVideoPlaneGetsizeNative(IntPtr obj);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoVideoPlaneSetsizeNative(IntPtr obj, ulong size);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern ulong VidyoVideoPlaneGetwidthNative(IntPtr obj);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoVideoPlaneSetwidthNative(IntPtr obj, ulong width);
